...
ggplot() +
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = grossrent),
          color = "transparent") +
  scale_fill_viridis_c() +
  geom_sf(data = acsTractsPHL.2019.sf %>%
            filter(Neighborhood == "Mayfair") %>%
            st_union(),
          aes(color = "Mayfair\nCensus tracts"),
          fill = "transparent") +
  scale_color_manual("", breaks = "Mayfair\nCensus tracts", values = "gray") +
  scale_x_continuous(breaks = c(-75, -75.1, -75.2)) +
  labs(
    title = "Estimate of median gross rent",
    subtitle = "2015-2019 ACS 5-year Estimates",
